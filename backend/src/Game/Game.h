...
/*!
 *  Composite class which perpouse is to hold gamestate, change it and assert winers of the game
 */
class Game
{
public:
	...
	* @param _board shared ptr to some board
	*/
	...
	*/
	...
	/*!
	 * Function that checks if the board is won
	...
	/*!
	 * Function that checks if the board of given index is won
	 ...
	 */
	win is_won(const int X, const int Y);


	/*!
	 * Function that searches for move that wins board of specific index
	 * @param X index of the board
	 * @param Y index of the board
	 * @param sign of the player that serches for wining move
	 * @return Pair of intigers which represent index of wining move
	 */
	std::pair<int, int> checkWin(const int X, const int Y, sign sign);
	 ...
	 * @return Pair of intigers which represent index of wining move
	 */
	std::pair<int, int> checkWin(sign sign);

	/*!
	 * Function that counts how many more moves player needs to win given board
	 * @param X index of the board
	 * @param Y index of the board
	 * @param sign of the player that serches for wining move
	...
	/*!
	 * Function that counts how many more moves player needs to win board
	 * @param sign of the player that serches for wining move
	 * @return number of moves needed to win bord
	 */
	int countMovesToWin(sign sign);


	/*!
	 * Function that counts how many more moves player needs to win board with cashe which prevents counting the same state twice
	 * @param sign of the player that serches for wining move
	...
	/*!
	 * Returns reference to two-dimensional dynamic array of Fields which are other boards or signs which represents TicTacToe board
	 * @return size of the game
	 */
	Grid& getGrid();

	/*!
	 * Returns the Board on which game is taking place on
	 * @return size of the game
	 */
	Board* getBoard();

	/*!
	 * Returns the controler to the game
